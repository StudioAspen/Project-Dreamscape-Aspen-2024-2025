...
{
  [field: Header("Fireball Configuration")]

  /// <summary>
  /// The number of times the player must hit Dreamons with Fireball to complete the quest.
  /// </summary>
  [field: Tooltip("The number of times the player must hit Dreamons with Fireball to complete the quest.")]
  [field: Range(1, 10)]
  [field: SerializeField] public int SuccessfulHitsGoal { get; private set; }

  /// <summary>
  /// The display name of the Fireball Combo Data.
  /// </summary>
  private const string DISPLAY_NAME = "Fireball";

  /// <summary>
  /// The number of times the player has hit Dreamons with Fireball.
  /// </summary>
