...
public class PlayerChargeState : PlayerBaseState
{
    ...
    public override void OnEnter()
    {
        ...
        ChargeAttackActivatedStatusEffectSO chargeAttackActivatedStatusEffect =
            EntityStatusEffector.TryGetStatusEffect<ChargeAttackActivatedStatusEffectSO>(player.gameObject, ChargeActivatedStatusEffect);
    ...
    {
        if (!EntityStatusEffector.HasStatusEffectOfType<ChargeAttackActivatedStatusEffectSO>(player.gameObject)) return false;
